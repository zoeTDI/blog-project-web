...
const mockData = [
  ...
  {id: 4, url: 'https://ob-tc-caldm-1315806820.cos.ap-nanjing.myqcloud.com/blog/20260523160825695.webp', alt: '只狼'},
  {
    id: 5,
    url: 'https://ob-tc-caldm-1315806820.cos.ap-nanjing.myqcloud.com/blog/20260523160825696.webp',
    alt: '赛博朋克：2077'
  },
  {id: 6, url: 'https://ob-tc-caldm-1315806820.cos.ap-nanjing.myqcloud.com/blog/20260523160825707.webp', alt: '巫师三'},
  {
    id: 7,
  ...
  {id: 12, url: 'https://ob-tc-caldm-1315806820.cos.ap-nanjing.myqcloud.com/blog/20260523160825699.webp', alt: '暖雪'},
  {
    id: 13,
    url: 'https://ob-tc-caldm-1315806820.cos.ap-nanjing.myqcloud.com/blog/20260523160825700.webp',
    alt: '了不起的修仙模拟器'
  },
  {id: 14, url: 'https://ob-tc-caldm-1315806820.cos.ap-nanjing.myqcloud.com/blog/20260523160825701.webp', alt: '龙崖'},
  {id: 11, url: 'https://ob-tc-caldm-1315806820.cos.ap-nanjing.myqcloud.com/blog/20260523160825702.webp', alt: 'Noita'},
  {
    id: 15,
    ...
    <section class="game-list">
      <ca-row :gap="20">
        <ca-col v-for="item in baseData" :key="item.id" :span="6">
          <router-link :to="{name: ROUTER_NAMES.GAME_DETAIL, params: {id: item.id}}">
