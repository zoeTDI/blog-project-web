import type { CustomPreferencesRecord, PreferencesExtension } from '../types';

export const defaultCustomPreference: CustomPreferencesRecord = {
  showAnnouncement: true,
  announcementText: '欢迎访问电子灭虫录！',
  maxMomentsCount: 10,
  contentGravity: 'left',
};
